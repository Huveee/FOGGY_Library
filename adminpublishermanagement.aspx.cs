    ...
    public partial class WebForm5 : System.Web.UI.Page
    {
        ...
        void getPublisherByID()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT * from PUBLISHER where ID='" + TextBox1.Text.Trim() + "';", con);
        ...
        void addNewPublisher()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO PUBLISHER(NAME) values(@NAME)", con);
        ...
        public void updatePublisherByID()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("update PUBLISHER set NAME=@NAME WHERE ID='" + TextBox1.Text.Trim() + "'", con);
                cmd.Parameters.AddWithValue("@NAME", TextBox2.Text.Trim().ToUpper());
        ...
        public void deletePublisherByID()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("Delete from PUBLISHER WHERE ID='" + TextBox1.Text.Trim() + "'", con);
                int result = cmd.ExecuteNonQuery();
                con.Close();
                if (result > 0)
                {
